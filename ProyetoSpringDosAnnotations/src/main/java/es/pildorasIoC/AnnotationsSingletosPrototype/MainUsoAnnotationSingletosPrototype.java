...
public class MainUsoAnnotationSingletosPrototype {

	public static void main(String[] args) {


		// *********** 01 leer el xml de configuración ********
		ClassPathXmlApplicationContext contextoAnnotation = new ClassPathXmlApplicationContext("aplicacionContexAnnotationSingletonPrototype.xml");
		...
		Empleados antonio = contextoAnnotation.getBean("comercialExperimentadoSingletosPrototype", Empleados.class);
		Empleados lucia = contextoAnnotation.getBean("comercialExperimentadoSingletosPrototype", Empleados.class);

		if (antonio == lucia){
			System.out.println("******* Patron Sigleton ********");
			System.out.println("Codigos Hash");
			System.out.println("Antonio hashCode() ==> " + antonio.hashCode());
			System.out.println("Lucia hashCode()   ==> " + lucia.hashCode());
			System.out.println();
			System.out.println("Direciones de memoria");
